...
>
    <div class="mx-auto flex h-16 items-center justify-between gap-4 px-4 sm:px-6 lg:px-8">
        ...
        <div class="flex items-center gap-1.5 sm:gap-2">
            ...
            @if (setting('theme.dark_mode_enabled', false))
                <button
                    type="button"
                    x-data
                ...
                >
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" x-show="$store.theme.current === 'light'" x-cloak class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.8" aria-hidden="true">
